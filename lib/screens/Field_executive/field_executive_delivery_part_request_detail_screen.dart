...
class FieldExecutiveDeliveryPartRequestDetailScreen extends StatelessWidget {
  final int roleId;
  final String roleName;
  final int? userId;
  final String requestId;

  const FieldExecutiveDeliveryPartRequestDetailScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    return FieldExecutiveDeliveryDetailBaseScreen(
      ...
      requestId: requestId,
      appBarTitle: 'Part Request Detail',
